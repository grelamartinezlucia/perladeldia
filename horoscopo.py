...
PREDICCIONES = [
    ...
    "Hoy el universo te guiña un ojo. O es un tic. Difícil saberlo.",
    "Tu productividad hoy será inversamente proporcional al buen tiempo.",
    "Los astros predicen que dirás 'cinco minutitos más' al menos tres veces.",
    "Hoy tu suerte estará en modo avión. No molestar.",
    "El cosmos sugiere que ese antojo de las 3 AM es totalmente válido.",
    "Marte entra en cuadratura con tu motivación. Tradución: sofá.",
    "Tu signo indica que hoy será un día. Eso es todo. Un día.",
    "Las estrellas recomiendan que finjas entender de vinos en la cena.",
    "Hoy sentirás una conexión profunda con el botón de repetir alarma.",
    "Venus dice que te arregles. Tu pijama opina diferente.",
    "El eclipse lunar afecta tu capacidad de elegir qué cenar.",
    "Hoy el destino te sonríe. Pero con cara de circunstancias.",
    "Tu energía astral sugiere responder 'jaja sí' a todo hoy.",
    "Los planetas indican que ese 'ya casi llego' es mentira.",
    "Saturno entra en tu casa del orden. Buena suerte con eso.",
    "Hoy descubrirás que pensar en hacer ejercicio no cuenta como ejercicio.",
    "El universo te envía abundancia. De notificaciones sin importancia.",
    "Tu carta astral revela talento oculto para evitar llamadas.",
    "Neptuno susurra que mereces ese tercer café. Hazle caso.",
    "Hoy la luna influye en tus emociones. Llorarás con un anuncio.",
    "Los astros confirman que ese grupo de WhatsApp debería ser un email.",
    "Plutón, el ex-planeta, te recuerda que las etiquetas no importan.",
    "Hoy tu intuición brillará eligiendo la fila más lenta del súper.",
    "El cosmos pregunta: ¿de verdad necesitas 47 pestañas abiertas?",
    "Júpiter favorece los planes ambiciosos. Como ducharte antes de las 12.",
    "Las estrellas dicen que sí, esa persona te ha dejado en visto a propósito.",
    "Hoy Mercurio retrógrado te hará enviar un mensaje al grupo equivocado.",
    "Tu aura pide descanso. Tu jefe probablemente no estará de acuerdo.",
    "Venus entra en tu zona de confort. Quédate ahí, está bien.",
    "Hoy tendrás suerte en juegos de azar. Tipo piedra, papel o tijera.",
]
